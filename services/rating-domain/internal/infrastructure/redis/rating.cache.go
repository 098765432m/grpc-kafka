...
import (
	...
	"github.com/098765432m/grpc-kafka/rating-domain/internal/domain"
...
func (rrs *RedisRatingCache) SetRatingByHotelId(ctx context.Context, hotelId string, ratings []domain.Rating) error {
	key := fmt.Sprintf("rating:hotel:%s", hotelId)
